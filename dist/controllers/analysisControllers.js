...
const AnalysisServices = __importStar(require("../services/analysisServices"));
const GetAnalysisWithDay = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const analysises = yield AnalysisServices.GetAnalysisWithDay({
            user_id: user.id,
            begin_date,
            end_date,
            type: durationType,
...
const GetAnalysisWithMonth = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = req.body.user;
    const begin_date = req.query.begin_date;
    const end_date = req.query.end_date;
    const durationType = req.query.type;
    const description = req.query.description;
    try {
        const analysises = yield AnalysisServices.GetAnalysisWithMonth({
            user_id: user.id,
            begin_date,
            end_date,
            type: durationType,
